  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-foreground">{t('admin.settings')}</h2>
        ...
        <Tabs defaultValue="doctor" className="space-y-6">
          ...
          <TabsContent value="doctor" className="space-y-6">
            {doctor && (
              <>
                  ...
                  <CardContent className="grid gap-6 sm:grid-cols-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setDoctor({ ...doctor, name_ar: e.target.value })}
                        dir="rtl"
                      />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setDoctor({ ...doctor, specialty_ar: e.target.value })}
                        dir="rtl"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setDoctor({ ...doctor, experience_years: parseInt(e.target.value) || 0 })}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setDoctor({ ...doctor, patients_count: parseInt(e.target.value) || 0 })}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        max="5"
                        value={doctor.rating} 
                        onChange={(e) => setDoctor({ ...doctor, rating: parseFloat(e.target.value) || 0 })}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setDoctor({ ...doctor, image_url: e.target.value })}
                        placeholder="https://..."
                      />
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="space-y-4">
                    {doctor.specializations.map((spec, index) => (
                      <div key={index} className="flex gap-4 items-end">
                        <div className="flex-1 space-y-2">
                          ...
                          <Input 
                            ...
                            onChange={(e) => {
                              ...
                              setDoctor({ ...doctor, specializations: newSpec });
                            }}
                          />
                        </div>
                        <div className="flex-1 space-y-2">
                        ...
                        <Button size="icon" variant="ghost" className="text-destructive" onClick={() => removeSpecialization(index)}>
                          <Trash2 className="h-4 w-4" />
                        </Button>
                      </div>
                    ))}
                  ...
                  <CardContent className="space-y-4">
                    {doctor.achievements.map((ach, index) => (
                      <div key={index} className="flex gap-4 items-end">
                        ...
                        <Button size="icon" variant="ghost" className="text-destructive" onClick={() => removeAchievement(index)}>
                          <Trash2 className="h-4 w-4" />
                        </Button>
                      </div>
                    ))}
                  ...
                  <CardContent className="grid gap-6 sm:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Textarea 
                        ...
                        onChange={(e) => setDoctor({ ...doctor, philosophy: e.target.value })}
                        rows={4}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Textarea 
                        ...
                        onChange={(e) => setDoctor({ ...doctor, philosophy_ar: e.target.value })}
                        rows={4}
                        dir="rtl"
                      />
                    </div>
                ...
                <Button onClick={handleSaveDoctor} disabled={updateMutation.isPending} className="w-full sm:w-auto">
          ...
          <TabsContent value="hero" className="space-y-6">
            {hero && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>{t('admin.heroDescription')}</CardDescription>
                </CardHeader>
                <CardContent className="grid gap-6 sm:grid-cols-2">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setHero({ ...hero, tagline_ar: e.target.value })}
                      dir="rtl"
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2 sm:col-span-2">
                    ...
                    <Textarea 
                      ...
                      onChange={(e) => setHero({ ...hero, subtitle_ar: e.target.value })}
                      rows={3}
                      dir="rtl"
                    />
                  </div>
            ...
            <Button onClick={handleSaveHero} disabled={updateMutation.isPending} className="w-full sm:w-auto">
              <Save className="h-4 w-4 mr-2" />
              {updateMutation.isPending ? t('common.saving') : t('admin.saveChanges')}
            </Button>
          </TabsContent>
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="space-y-2 sm:col-span-2">
                          ...
                          <Textarea 
                            ...
                            onChange={(e) => {
                              const newServices = [...services.items];
                              newServices[index].description_ar = e.target.value;
                              setServices({ items: newServices });
                            }}
                            rows={2}
                            dir="rtl"
