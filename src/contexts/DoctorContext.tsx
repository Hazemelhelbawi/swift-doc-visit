...
export const DoctorProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const resolveSlug = (): string => {
    ...
    const isPreviewOrLocal = hostname.includes("localhost") || hostname.includes("lovable") || hostname.includes("lovableproject") || hostname.includes("vercel") || hostname.includes("vercel.app");
