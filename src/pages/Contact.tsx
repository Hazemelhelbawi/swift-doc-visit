  ...
  const contactInfo = [
    {
      icon: Phone,
      label: "Phone",
      value: doctorProfile?.contact_phone || "+1 (555) 123-4567",
    },
    {
      icon: Mail,
      label: "Email",
      value: doctorProfile?.contact_email || "contact@drcare.com",
    },
    {
      icon: Clock,
      label: t("contact.info.hours"),
      value: isArabic
        ? doctorProfile?.working_hours_ar || t("contact.info.hoursValue")
    ...
    },
    {
      ...
      value: isArabic
        ...
        : doctorProfile?.contact_address || "123 Medical Center Dr, Suite 100",
    },
  ];
