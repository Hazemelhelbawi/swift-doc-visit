...
-- FIX 1: Replace RESTRICTIVE policies with PERMISSIVE ones
...
CREATE POLICY "Doctors can manage their own settings"
...
-- FIX 2: Create triggers to auto-set doctor_id on insert

CREATE TRIGGER set_doctor_id_clinics
  BEFORE INSERT ON public.clinics
  FOR EACH ROW
  EXECUTE FUNCTION public.set_doctor_id_on_insert();
...
CREATE TRIGGER set_doctor_id_appointments_admin
